...
const inputClass =
  "focus-ring w-full rounded-xl border border-line bg-surface px-3.5 py-2.5 text-sm text-ink transition focus:border-coral-dark";
    ...
    >
      <div className="mx-auto max-w-xl">
        ...
        <button
          ...
          className="mt-8 flex w-full items-center justify-center gap-2 rounded-xl bg-coral py-3.5 text-sm font-bold text-ink transition disabled:cursor-not-allowed disabled:opacity-40"
        >
