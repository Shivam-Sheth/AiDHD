  ...
  return (
    <div
      className={clsx(
        ...
        isMostVoted ? "border-ink shadow-card" : "border-line",
      )}
    >
      {isMostVoted && (
        <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-ink px-3 py-1 text-[10px] font-bold tracking-wide text-inverse uppercase">
          Most voted
        </span>
      )}
      ...
      <button
        ...
        className={clsx(
          ...
          isMostVoted ? "bg-ink text-surface" : "border border-ink text-inverse hover:bg-canvas",
        )}
      >
        View details
      </button>
