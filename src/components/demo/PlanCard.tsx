  ...
  return (
    <button
      ...
      className={clsx(
        ...
        selected
          ? "border-coral bg-gradient-to-br from-coral/10 to-gold/10 shadow-warm"
          : "border-line bg-paper hover:border-coral-dark/40",
      )}
    >
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0">
          <div className="font-display font-semibold text-ink">{pkg.label}</div>
