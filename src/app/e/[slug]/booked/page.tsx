    ...
    return (
      <div className="py-8 text-center">
        ...
        <button
          ...
          className="mt-4 rounded-lg border border-ink px-5 py-2.5 text-sm font-bold text-ink"
        >
          Back to packages
        </button>
      </div>
    ...
    <div className="mx-auto max-w-md text-center">
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-3">
        <button
          ...
          className="rounded-lg bg-ink px-5 py-2.5 text-sm font-bold text-surface"
        >
          Add to calendar
        </button>
        <button
          ...
          className="rounded-lg border border-ink px-5 py-2.5 text-sm font-bold text-ink"
        >
          Share with group
        </button>
      </div>
