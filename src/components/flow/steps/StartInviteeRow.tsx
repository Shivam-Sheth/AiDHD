    ...
    <div className="flex flex-wrap items-center gap-2">
      ...
      {canAdd && (
        <button
          ...
          className="flex h-10 w-10 items-center justify-center rounded-full border-2 border-dashed border-line text-faint transition hover:border-ink/40 hover:text-ink"
        >
