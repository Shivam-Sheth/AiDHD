...
export function BookingResultPanel({
  ...
  return (
    <div className="rounded-xl border border-success/25 bg-success-soft p-4 text-center">
      ...
      {failedBooking && (
        <div className="mt-4 rounded-lg border border-danger/25 bg-danger-soft p-3 text-left">
          ...
          <button
            ...
            className="mt-2 rounded-lg bg-danger px-3 py-1.5 text-xs font-semibold text-white disabled:opacity-50"
          >
      ...
      <button type="button" onClick={onReset} className="mt-5 text-sm font-semibold text-coral-dark">
        Run again
      </button>
    </div>
  );
